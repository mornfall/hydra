...
create table Jobsets (
    ...
    project       text not null,
    description   text,
    exprType      text not null, -- "nix" or "guile"
    nixExprInput  text not null, -- name of the jobsetInput containing the Nix/Guix expression
    nixExprPath   text not null, -- relative path of the Nix/Guix expression
    guileExprEntry text, -- when "guile", entry point for the expression
